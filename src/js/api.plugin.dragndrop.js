...
// Set
api.plugin.dragndrop = {};

/**
 * Override locally
 * @param {*} filesArray
 */
api.plugin.dragndrop.readFiles = function (filesArray, inputObject) {
    filesArray = filesArray || null;
    inputObject = inputObject || null;
};

/**
 * Initiate the Drap n Drop
 * @param {*} document
 * @param {*} window
 */
api.plugin.dragndrop.initiate = function (document, window) {
    ...
    Array.prototype.forEach.call(forms, function (form) {
        ...
        input.addEventListener("change", function (e) {
            ...
            api.plugin.dragndrop.readFiles(droppedFiles, $(this));
        });
        ...
        if (isAdvancedUpload) {
            ...
            form.addEventListener("drop", function (e) {
                ...
                api.plugin.dragndrop.readFiles(droppedFiles, $(this).find('input[type="file"]'));
            });
        }
